...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(766, 636);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        textEdit = new QTextEdit(centralwidget);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(170, 370, 421, 121));
        ...
        tokenTable->setGeometry(QRect(170, 70, 411, 221));
        But1 = new QPushButton(centralwidget);
        But1->setObjectName("But1");
        But1->setGeometry(QRect(340, 520, 101, 41));
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(280, 30, 171, 31));
        QFont font;
